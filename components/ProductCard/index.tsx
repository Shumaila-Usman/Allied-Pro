...
export default function ProductCard({ product }: ProductCardProps) {
  ...
  return (
    <div className="group relative h-full rounded-2xl bg-gradient-to-r from-[#E6DBFF] to-[#D8F0FF] p-[2px] hover:shadow-md transition-shadow duration-300 cursor-pointer">
      <div
        className="bg-white rounded-[inherit] overflow-hidden flex flex-col h-full min-h-[340px]"
