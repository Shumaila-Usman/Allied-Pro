...
export default function AuthPage({ initialMode }: AuthPageProps) {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    const result = await login(loginData.email, loginData.password, undefined, false)
    setIsLoading(false)
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <div className="flex-1 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8" style={{ paddingTop: `${topPadding + 48}px` }}>
        <div className="max-w-6xl w-full">
            ...
            {isRegisterMode ? (
              <div className="bg-white rounded-2xl shadow-2xl p-6">
                ...
                <form onSubmit={handleRegister} className="space-y-4">
                  <div>
                    <label htmlFor="mobileFirstName" className="block text-sm font-medium text-gray-700 mb-1">
                      First Name
                    </label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label htmlFor="mobileLastName" className="block text-sm font-medium text-gray-700 mb-1">
                      Last Name
                    </label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label htmlFor="mobileRegisterEmail" className="block text-sm font-medium text-gray-700 mb-1">
                      Email Address
                    </label>
                    <input
                      type="email"
                  ...
                  <div>
                    <label htmlFor="mobileRegisterPassword" className="block text-sm font-medium text-gray-700 mb-1">
                      Password
                    </label>
                  ...
                  <div>
                    <label htmlFor="mobileConfirmPassword" className="block text-sm font-medium text-gray-700 mb-1">
                      Confirm Password
                    </label>
                    <div className="relative">
                      <input
              ...
              <div className="bg-white rounded-2xl shadow-2xl p-6">
                ...
                <form onSubmit={handleLogin} className="space-y-4">
                  <div>
                    <label htmlFor="mobileLoginEmail" className="block text-sm font-medium text-gray-700 mb-1">
                      Email Address
                    </label>
                    <input
                      type="email"
                  ...
                  <div>
                    <label htmlFor="mobileLoginPassword" className="block text-sm font-medium text-gray-700 mb-1">
                      Password
                    </label>
                    <div className="relative">
                      <input
          ...
          <div className="hidden md:block relative bg-white rounded-2xl shadow-2xl overflow-hidden" style={{ height: '600px' }}>
            {/* Error Message */}
            {error && (
